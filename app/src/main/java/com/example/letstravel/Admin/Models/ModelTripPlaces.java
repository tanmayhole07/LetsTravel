...
public class ModelTripPlaces {

    String placeImage, placeName, placeDescription, countryName, placeAvailablity, price, timeStamp;

    public ModelTripPlaces() {
    }

    public ModelTripPlaces(String placeImage, String placeName, String placeDescription, String countryName, String placeAvailablity, String price, String timeStamp) {
